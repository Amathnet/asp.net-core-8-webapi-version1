...
namespace Service
{
    internal sealed class ProductService : IProductService
    {
        ...
        public async Task<IEnumerable<ProductDto>> GetAllCompaniesAsync(bool trackChanges)
        {
            var companies = await _repository.Product.GetAllProductsAsync(trackChanges);
            var companiesDto = _mapper.Map<IEnumerable<ProductDto>>(companies);
            return companiesDto;
        }
